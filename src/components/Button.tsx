...
const buttonVariants = cva(
  "inline-flex font-medium transition-all duration-200 ease-out active:scale-97 active:shadow-inset justify-center disabled:opacity-50 disabled:pointer-events-none border-3 bg-linear-to-tl shadow-raised px-4 py-2 border-background items-center cursor-pointer hover:opacity-90 focus-visible:ring-foreground focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none ",
  {
    variants: {
      variant: {
